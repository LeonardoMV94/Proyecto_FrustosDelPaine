...
const ProductosServices = __importStar(require("../services/productos.service"));
const client_1 = require("@prisma/client");
const router = express_1.default.Router();
router.get("/", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const productos = yield ProductosServices.getAllProductos();
...
router.get("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const productos = yield ProductosServices.getOneProductoById(id);
        response.status(200).json(productos);
    }
    catch (error) {
...
router.put("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield ProductosServices.updateProducto(id, productoBody);
...
router.post("/", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const productoBody = request.body;
        const result = yield ProductosServices.createProducto(productoBody);
...
router.delete("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    const id = parseInt(request.params.id, 0);
    try {
        const result = yield ProductosServices.deleteProducto(id);
