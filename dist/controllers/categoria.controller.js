...
const CategoriaServices = __importStar(require("../services/categoria.service"));
const client_1 = require("@prisma/client");
const router = express_1.default.Router();
router.get("/", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const categoria = yield CategoriaServices.getAllCategoria();
...
router.get("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const categoria = yield CategoriaServices.getOnerCategoriaById(id);
        response.status(200).json(categoria);
    }
    catch (error) {
        response.status(500).json({ error, message: "error del servidor ", code: 500 });
...
router.put("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield CategoriaServices.updateCategoria(id, categoriaBody);
...
router.post("/", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const categoriaBody = request.body;
        const result = yield CategoriaServices.createCategoria(categoriaBody);
...
router.delete("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    const id = parseInt(request.params.id, 0);
    try {
        const result = yield CategoriaServices.deleteCategoria(id);
