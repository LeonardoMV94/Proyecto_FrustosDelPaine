...
const metodoPAgoServices = __importStar(require("../services/metodo-pago.service"));
const client_1 = require("@prisma/client");
const router = express_1.default.Router();
router.get("/", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const metodoPago = yield metodoPAgoServices.getAllMetodoPago();
...
router.get("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const categoria = yield metodoPAgoServices.getOneMetodoPagoById(id);
...
router.put("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield metodoPAgoServices.updateMetodoPago(id, metodoPAgoBody);
...
router.post("/", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const metodoPAgoBody = request.body;
        const result = yield metodoPAgoServices.createMetodoPago(metodoPAgoBody);
...
router.delete("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    const id = parseInt(request.params.id, 0);
    try {
        const result = yield metodoPAgoServices.deleteMetodoPago(id);
