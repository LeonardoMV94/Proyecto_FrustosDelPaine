...
const DireccionesServices = __importStar(require("../services/direcciones.service"));
const client_1 = require("@prisma/client");
const router = express_1.default.Router();
router.get("/", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const direcciones = yield DireccionesServices.getAllDirecciones();
...
router.get("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const direcciones = yield DireccionesServices.getOneDireccionById(id);
        response.status(200).json(direcciones);
    }
    catch (error) {
...
router.put("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield DireccionesServices.updateDirecciones(id, direccionBody);
...
router.post("/", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const direccionBody = request.body;
        const result = yield DireccionesServices.createDireccion(direccionBody);
...
router.delete("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    const id = parseInt(request.params.id, 0);
    try {
        const result = yield DireccionesServices.deleteDireccion(id);
