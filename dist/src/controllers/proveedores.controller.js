...
const ProveedoresServices = __importStar(require("../services/proveedores.service"));
const client_1 = require("@prisma/client");
const router = express_1.default.Router();
router.get("/", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const proveedores = yield ProveedoresServices.getAllProveedores();
...
router.get("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const proveedores = yield ProveedoresServices.getOneProveedorById(id);
        response.status(200).json(proveedores);
    }
    catch (error) {
        response.status(500).json({ error, message: "error del servidor ", code: 500 });
...
router.put("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield ProveedoresServices.updateProveedor(id, proveedorBody);
...
router.post("/", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const proveedorBody = request.body;
        const result = yield ProveedoresServices.createProveedor(proveedorBody);
...
router.delete("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    const id = parseInt(request.params.id, 0);
    try {
        const result = yield ProveedoresServices.deleteProveedor(id);
