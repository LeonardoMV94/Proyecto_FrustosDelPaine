...
const DetalleVentaServices = __importStar(require("../services/detalle-venta.service"));
const client_1 = require("@prisma/client");
const router = express_1.default.Router();
router.get("/", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const detalleVenta = yield DetalleVentaServices.getAllDetalleVenta();
...
router.get("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    const idVenta = parseInt(request.params.id, 0);
    const idProducto = parseInt(request.params.id, 0);
    const detalleVentaBody = request.body;
    try {
        const result = yield DetalleVentaServices.updateDetallateVenta(idVenta, idProducto, detalleVentaBody);
...
router.post("/", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const detalleVentaBody = request.body;
        const result = yield DetalleVentaServices.createDetalleVenta(detalleVentaBody);
...
router.delete("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const idProducto = parseInt(request.params.id, 0);
    try {
        const result = yield DetalleVentaServices.deteleDetalleVenta(idProducto, idVenta);
