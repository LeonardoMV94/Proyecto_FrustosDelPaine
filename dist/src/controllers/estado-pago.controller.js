...
const estadoPagoServices = __importStar(require("../services/estado-pago.service"));
const client_1 = require("@prisma/client");
const router = express_1.default.Router();
router.get("/", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const estadoPago = yield estadoPagoServices.getAllEstadoPago();
...
router.get("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const estadoPago = yield estadoPagoServices.getOneEstadoPagoById(id);
        response.status(200).json(estadoPago);
    }
    catch (error) {
        response.status(500).json({ error, message: "Error del servidor ", code: 500 });
...
router.put("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield estadoPagoServices.updateEstadoPago(id, estadoPagoBody);
...
router.post("/", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const estadoPagoBody = request.body;
        const result = yield estadoPagoServices.createEstadoPago(estadoPagoBody);
...
router.delete("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    const id = parseInt(request.params.id, 0);
    try {
        const result = yield estadoPagoServices.deleteEstadoPago(id);
