...
const TipoUsuarioServices = __importStar(require("../services/tipo-usuario.service"));
const client_1 = require("@prisma/client");
const router = express_1.default.Router();
router.get("/", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const tipoUsuarios = yield TipoUsuarioServices.getAllTipoUsuario();
...
router.get("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const tipoUsuario = yield TipoUsuarioServices.getOneTipoUsuarioById(id);
...
router.put("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield TipoUsuarioServices.updateTipoUsuario(id, tipoUsuarioBody);
...
router.post("/", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const tipoUsuarioBody = request.body;
        const result = yield TipoUsuarioServices.createTipoUsuario(tipoUsuarioBody);
...
router.delete("/:id", (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    const id = parseInt(request.params.id, 0);
    try {
        const result = yield TipoUsuarioServices.deleteTipoUsuario(id);
